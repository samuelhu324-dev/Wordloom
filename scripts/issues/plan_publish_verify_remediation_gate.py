...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--context-mode", dest="context_mode", choices=["preserve-existing", "llm-generate"], default="preserve-existing", help="Pass through the issue-conclusion context rendering mode when delegated issue-conclusion apply is requested")
