...
| `CRL-02` | `docs/logs/log-S4G-1G-search-runtime-scenario-hard-extraction-packet.md#P1; #P2; #P3` | `mixed` | `scenario universe wider than current contract family` | `coverage-table; release-change; defer` | `classified-no-contract-widening` | `none` | `none` | `none` | `P3 records that the current contract stays narrow: only the already-defended proof path remains in the contract body, while the other current-family scenarios stay admitted at the release-ledger layer.` |
...
- `CRL-02-SC-12` through `CRL-02-SC-20` should be read as migration or cutover-adjacent Search scenarios rather than as latent contract clauses waiting to be promoted.
...
- These rows stay visible here only so the current release-ledger can explain why they were kept outside positive contract meaning and where a later sibling packet should pick them up.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `CRL-02-SC-01` | `CRL-02` | `es_429_inject` | `current-family` | `release-ledger-only` | `release-ledger` | `retained-here` | `release-ledger-only` | `CRL-02` | `CRL-02-SC-E21` | `CRL-02-SUP-01; CRL-02-SUP-02; CRL-02-SUP-03` | `P3 keeps this current-family scenario in the release ledger because the contract still owns only the first defended proof path.` |
...
| `CRL-02-SC-03` | `CRL-02` | `es_down_connect` | `current-family` | `release-ledger-only` | `release-ledger` | `retained-here` | `release-ledger-only` | `CRL-02` | `CRL-02-SC-E22` | `CRL-02-SUP-01; CRL-02-SUP-02; CRL-02-SUP-03` | `P3 keeps this current-family scenario in the release ledger because the contract still owns only the first defended proof path.` |
| `CRL-02-SC-04` | `CRL-02` | `es_timeout` | `current-family` | `release-ledger-only` | `release-ledger` | `retained-here` | `release-ledger-only` | `CRL-02` | `CRL-02-SC-E23` | `CRL-02-SUP-01; CRL-02-SUP-02; CRL-02-SUP-03` | `P3 keeps this current-family scenario in the release ledger because the contract still owns only the first defended proof path.` |
| `CRL-02-SC-05` | `CRL-02` | `es_bulk_partial` | `current-family` | `release-ledger-only` | `release-ledger` | `retained-here` | `release-ledger-only` | `CRL-02` | `CRL-02-SC-E24` | `CRL-02-SUP-01; CRL-02-SUP-02; CRL-02-SUP-03` | `P3 keeps this current-family scenario in the release ledger because the contract still owns only the first defended proof path.` |
| `CRL-02-SC-06` | `CRL-02` | `db_claim_contention` | `current-family` | `release-ledger-only` | `release-ledger` | `retained-here` | `release-ledger-only` | `CRL-02` | `CRL-02-SC-E25` | `CRL-02-SUP-01; CRL-02-SUP-02; CRL-02-SUP-03` | `P3 keeps this current-family scenario in the release ledger because the contract still owns only the first defended proof path.` |
| `CRL-02-SC-07` | `CRL-02` | `stuck_reclaim` | `current-family` | `release-ledger-only` | `release-ledger` | `retained-here` | `release-ledger-only` | `CRL-02` | `CRL-02-SC-E26` | `CRL-02-SUP-01; CRL-02-SUP-02; CRL-02-SUP-03` | `P3 keeps this current-family scenario in the release ledger because the contract still owns only the first defended proof path.` |
| `CRL-02-SC-08` | `CRL-02` | `duplicate_delivery` | `current-family` | `release-ledger-only` | `release-ledger` | `retained-here` | `release-ledger-only` | `CRL-02` | `CRL-02-SC-E27` | `CRL-02-SUP-01; CRL-02-SUP-02; CRL-02-SUP-03` | `P3 keeps this current-family scenario in the release ledger because the contract still owns only the first defended proof path.` |
| `CRL-02-SC-09` | `CRL-02` | `projection_version` | `current-family` | `release-ledger-only` | `release-ledger` | `retained-here` | `release-ledger-only` | `CRL-02` | `CRL-02-SC-E28` | `CRL-02-SUP-01; CRL-02-SUP-02; CRL-02-SUP-03` | `P3 keeps this current-family scenario in the release ledger because the contract still owns only the first defended proof path.` |
...
| `CRL-02-SC-12` | `CRL-02` | `shadow_verify_search_index_write_gate` | `sibling-family` | `not-owned-here` | `pending-sibling-lane` | `routed-out-pending` | `migration-or-cutover-sibling-ledger` | `pending-later-sibling-packet` | `CRL-02-SC-E12` | `CRL-02-SUP-01; CRL-02-SUP-03` | `Search write-gate verification stays outside current contract ownership because it belongs to a later migration or cutover sibling lane.` |
| `CRL-02-SC-13` | `CRL-02` | `shadow_verify_search_index_paging_stability` | `sibling-family` | `not-owned-here` | `pending-sibling-lane` | `routed-out-pending` | `migration-or-cutover-sibling-ledger` | `pending-later-sibling-packet` | `CRL-02-SC-E13` | `CRL-02-SUP-01; CRL-02-SUP-03` | `Search paging-stability verification stays outside current contract ownership because it belongs to a later migration or cutover sibling lane.` |
| `CRL-02-SC-14` | `CRL-02` | `rehearsal_search_read_switch_smoke` | `sibling-family` | `not-owned-here` | `pending-sibling-lane` | `routed-out-pending` | `migration-or-cutover-sibling-ledger` | `pending-later-sibling-packet` | `CRL-02-SC-E14` | `CRL-02-SUP-01; CRL-02-SUP-03` | `Read-switch rehearsal stays outside current contract ownership because it belongs to a later migration or cutover sibling lane.` |
| `CRL-02-SC-15` | `CRL-02` | `shadow_verify_dual_run_readiness_gate` | `sibling-family` | `not-owned-here` | `pending-sibling-lane` | `routed-out-pending` | `migration-or-cutover-sibling-ledger` | `pending-later-sibling-packet` | `CRL-02-SC-E15` | `CRL-02-SUP-01; CRL-02-SUP-03` | `Dual-run readiness stays outside current contract ownership because it belongs to a later migration or cutover sibling lane.` |
| `CRL-02-SC-16` | `CRL-02` | `shadow_verify_dual_run_stage1` | `sibling-family` | `not-owned-here` | `pending-sibling-lane` | `routed-out-pending` | `migration-or-cutover-sibling-ledger` | `pending-later-sibling-packet` | `CRL-02-SC-E16` | `CRL-02-SUP-01; CRL-02-SUP-03` | `Dual-run stage execution stays outside current contract ownership because it belongs to a later migration or cutover sibling lane.` |
| `CRL-02-SC-17` | `CRL-02` | `shadow_verify_dual_run_stage2` | `sibling-family` | `not-owned-here` | `pending-sibling-lane` | `routed-out-pending` | `migration-or-cutover-sibling-ledger` | `pending-later-sibling-packet` | `CRL-02-SC-E17` | `CRL-02-SUP-01; CRL-02-SUP-03` | `Dual-run stage execution stays outside current contract ownership because it belongs to a later migration or cutover sibling lane.` |
| `CRL-02-SC-18` | `CRL-02` | `shadow_verify_dual_run_window` | `sibling-family` | `not-owned-here` | `pending-sibling-lane` | `routed-out-pending` | `migration-or-cutover-sibling-ledger` | `pending-later-sibling-packet` | `CRL-02-SC-E18` | `CRL-02-SUP-01; CRL-02-SUP-03` | `Coexistence-window handling stays outside current contract ownership because it belongs to a later migration or cutover sibling lane.` |
| `CRL-02-SC-19` | `CRL-02` | `shadow_verify_canary_dual_write` | `sibling-family` | `not-owned-here` | `pending-sibling-lane` | `routed-out-pending` | `migration-or-cutover-sibling-ledger` | `pending-later-sibling-packet` | `CRL-02-SC-E19` | `CRL-02-SUP-01; CRL-02-SUP-03` | `Canary dual-write stays outside current contract ownership because it belongs to a later migration or cutover sibling lane.` |
| `CRL-02-SC-20` | `CRL-02` | `shadow_verify_dual_write_sampling` | `sibling-family` | `not-owned-here` | `pending-sibling-lane` | `routed-out-pending` | `migration-or-cutover-sibling-ledger` | `pending-later-sibling-packet` | `CRL-02-SC-E20` | `CRL-02-SUP-01; CRL-02-SUP-03` | `Dual-write sampling stays outside current contract ownership because it belongs to a later migration or cutover sibling lane.` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `CRL-02-SC-01` | `unknown` | `2026-04-27` | `2026-04-27` | `2026-04-27` | `day` | `none` | `P3 records a deliberate no-contract-widening decision for this current-family scenario.` |
...
| `CRL-02-SC-03` | `unknown` | `2026-04-27` | `2026-04-27` | `2026-04-27` | `day` | `none` | `P3 records a deliberate no-contract-widening decision for this current-family scenario.` |
| `CRL-02-SC-04` | `unknown` | `2026-04-27` | `2026-04-27` | `2026-04-27` | `day` | `none` | `P3 records a deliberate no-contract-widening decision for this current-family scenario.` |
| `CRL-02-SC-05` | `unknown` | `2026-04-27` | `2026-04-27` | `2026-04-27` | `day` | `none` | `P3 records a deliberate no-contract-widening decision for this current-family scenario.` |
| `CRL-02-SC-06` | `unknown` | `2026-04-27` | `2026-04-27` | `2026-04-27` | `day` | `none` | `P3 records a deliberate no-contract-widening decision for this current-family scenario.` |
| `CRL-02-SC-07` | `unknown` | `2026-04-27` | `2026-04-27` | `2026-04-27` | `day` | `none` | `P3 records a deliberate no-contract-widening decision for this current-family scenario.` |
| `CRL-02-SC-08` | `unknown` | `2026-04-27` | `2026-04-27` | `2026-04-27` | `day` | `none` | `P3 records a deliberate no-contract-widening decision for this current-family scenario.` |
| `CRL-02-SC-09` | `unknown` | `2026-04-27` | `2026-04-27` | `2026-04-27` | `day` | `none` | `P3 records a deliberate no-contract-widening decision for this current-family scenario.` |
...
| `CRL-02-SC-E21` | `CRL-02-SC-01` | `retained-in-ledger` | `release-ledger` | `CRL-02` | `role:s4g-packet-maintainer` | `Scenario remains admitted in the contract release ledger but is not promoted into current contract meaning.` | `2026-04-27` | `CRL-02; docs/logs/log-S4G-1G-search-runtime-scenario-hard-extraction-packet.md#P3-C1-S2` | `P3 records an explicit no-contract-widening path for this current-family scenario.` |
| `CRL-02-SC-E22` | `CRL-02-SC-03` | `retained-in-ledger` | `release-ledger` | `CRL-02` | `role:s4g-packet-maintainer` | `Scenario remains admitted in the contract release ledger but is not promoted into current contract meaning.` | `2026-04-27` | `CRL-02; docs/logs/log-S4G-1G-search-runtime-scenario-hard-extraction-packet.md#P3-C1-S2` | `P3 records an explicit no-contract-widening path for this current-family scenario.` |
| `CRL-02-SC-E23` | `CRL-02-SC-04` | `retained-in-ledger` | `release-ledger` | `CRL-02` | `role:s4g-packet-maintainer` | `Scenario remains admitted in the contract release ledger but is not promoted into current contract meaning.` | `2026-04-27` | `CRL-02; docs/logs/log-S4G-1G-search-runtime-scenario-hard-extraction-packet.md#P3-C1-S2` | `P3 records an explicit no-contract-widening path for this current-family scenario.` |
| `CRL-02-SC-E24` | `CRL-02-SC-05` | `retained-in-ledger` | `release-ledger` | `CRL-02` | `role:s4g-packet-maintainer` | `Scenario remains admitted in the contract release ledger but is not promoted into current contract meaning.` | `2026-04-27` | `CRL-02; docs/logs/log-S4G-1G-search-runtime-scenario-hard-extraction-packet.md#P3-C1-S2` | `P3 records an explicit no-contract-widening path for this current-family scenario.` |
| `CRL-02-SC-E25` | `CRL-02-SC-06` | `retained-in-ledger` | `release-ledger` | `CRL-02` | `role:s4g-packet-maintainer` | `Scenario remains admitted in the contract release ledger but is not promoted into current contract meaning.` | `2026-04-27` | `CRL-02; docs/logs/log-S4G-1G-search-runtime-scenario-hard-extraction-packet.md#P3-C1-S2` | `P3 records an explicit no-contract-widening path for this current-family scenario.` |
| `CRL-02-SC-E26` | `CRL-02-SC-07` | `retained-in-ledger` | `release-ledger` | `CRL-02` | `role:s4g-packet-maintainer` | `Scenario remains admitted in the contract release ledger but is not promoted into current contract meaning.` | `2026-04-27` | `CRL-02; docs/logs/log-S4G-1G-search-runtime-scenario-hard-extraction-packet.md#P3-C1-S2` | `P3 records an explicit no-contract-widening path for this current-family scenario.` |
| `CRL-02-SC-E27` | `CRL-02-SC-08` | `retained-in-ledger` | `release-ledger` | `CRL-02` | `role:s4g-packet-maintainer` | `Scenario remains admitted in the contract release ledger but is not promoted into current contract meaning.` | `2026-04-27` | `CRL-02; docs/logs/log-S4G-1G-search-runtime-scenario-hard-extraction-packet.md#P3-C1-S2` | `P3 records an explicit no-contract-widening path for this current-family scenario.` |
| `CRL-02-SC-E28` | `CRL-02-SC-09` | `retained-in-ledger` | `release-ledger` | `CRL-02` | `role:s4g-packet-maintainer` | `Scenario remains admitted in the contract release ledger but is not promoted into current contract meaning.` | `2026-04-27` | `CRL-02; docs/logs/log-S4G-1G-search-runtime-scenario-hard-extraction-packet.md#P3-C1-S2` | `P3 records an explicit no-contract-widening path for this current-family scenario.` |
...
| `CRL-E04` | `writeback-decision-recorded` | `CRL-02` | `role:s4g-packet-maintainer` | `current contract remains narrow while additional current-family scenarios stay admitted only at the release-ledger layer` | `2026-04-27` | `docs/logs/log-S4G-1G-search-runtime-scenario-hard-extraction-packet.md#P3-C1-S2` | `P3 records a no-contract-widening path instead of silently leaving the current-family scenarios in indefinite pending state.` |

## Reader Notes

- Landed in the contract already: the bounded current worker-chain contract basis represented by `CRL-01`.
- Admitted in the release ledger but deliberately kept outside the current contract body: the wider current-family scenario inventory represented by `CRL-02`, except for the already-landed proof path `CRL-02-SC-02`.
- Still intentionally unchanged: the contract does not widen just because the sibling runbook exists, as preserved by `CRL-03`.
- Scenario-level routing remains explicit under `CRL-02`, so reviewers can now distinguish which scenario already lands in the contract, which current-family scenarios remain release-ledger-only by deliberate no-op decision, and which are really migration or cutover sibling-lane scenarios rather than latent contract clauses.