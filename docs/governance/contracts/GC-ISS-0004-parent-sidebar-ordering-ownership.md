...
contract_record:
  ...
  last_changed_by: S0F-1G/P1-C1-S2
  source_refs:
    - docs/logs/log-S0F-1G-parent-issue-sidebar-ordering-and-title-keyword-governance.md
  supersedes: []
  superseded_by: []
  notes:
    - Later S0F-1G phases re-verify and reconverge live parent lanes, but the stable semantic rule is fixed at the P1 ownership boundary.
```
