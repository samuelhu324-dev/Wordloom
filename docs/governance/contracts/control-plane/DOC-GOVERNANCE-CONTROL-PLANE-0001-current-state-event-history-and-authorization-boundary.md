# DOC-GOVERNANCE-CONTROL-PLANE-0001 current-state event-history and authorization boundary

```yaml
contract_record:
  contract_family: DOC-GOVERNANCE-CONTROL-PLANE
  contract_release: 0001
  contract_id: DOC-GOVERNANCE-CONTROL-PLANE-0001
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `DOC-GOVERNANCE-CONTROL-PLANE-0001-CH-01` | `DOC-GOVERNANCE-CONTROL-PLANE-0001` | `introduced` | `none` | `DOC-GOVERNANCE-CONTROL-PLANE-0001-ST-01; DOC-GOVERNANCE-CONTROL-PLANE-0001-ST-02; DOC-GOVERNANCE-CONTROL-PLANE-0001-ST-03; DOC-GOVERNANCE-CONTROL-PLANE-0001-ST-04; DOC-GOVERNANCE-CONTROL-PLANE-0001-ST-05; DOC-GOVERNANCE-CONTROL-PLANE-0001-ST-06` | `2026-04-15` | `2026-04-15` | The first DOC-first control-plane contract is now explicit enough to own the shared vocabulary, current-state versus event-history placement rule, and authorization boundary after two bounded sample rounds proved the shape locally. | `S0F-9A/P0-C1-S1S2S3; S0F-9A/P3-C1-S1S2; S0F-9A/P3-C2-S1S2` | The release is intentionally narrow: it fixes reusable control-plane semantics without yet opening a broader runtime authorization model. |
...
- `DOC-GOVERNANCE-CONTROL-PLANE-0001-ST-01`: Current effective governance state should read through explicit current-state fields such as `owner_team`, `current_steward`, `approval_state`, `reviewed_by`, and `approved_by`.
- `DOC-GOVERNANCE-CONTROL-PLANE-0001-ST-02`: `verified_by` should remain a packet-level evidence-accountability field unless later evidence proves a narrower current-state use that should be owned by a different contract.
- `DOC-GOVERNANCE-CONTROL-PLANE-0001-ST-03`: Contribution, direct-evidence review, stewardship movement, and handoff history should be recorded in event tables, supplements, or comparable historical-accountability surfaces rather than in current-state frontmatter.
- `DOC-GOVERNANCE-CONTROL-PLANE-0001-ST-04`: Governance records must not overload one generic `actor` field to carry distinct meanings that belong to owner, steward, reviewer, approver, verifier, contributor, or handoff actor roles.
- `DOC-GOVERNANCE-CONTROL-PLANE-0001-ST-05`: The minimum reusable event vocabulary for this lane includes contribution and handoff semantics, with narrower delegated-stewardship or role-separation events admitted when samples justify them.
- `DOC-GOVERNANCE-CONTROL-PLANE-0001-ST-06`: Authorization, entitlement, billing, and broader product-access semantics remain out of scope for this contract family.
