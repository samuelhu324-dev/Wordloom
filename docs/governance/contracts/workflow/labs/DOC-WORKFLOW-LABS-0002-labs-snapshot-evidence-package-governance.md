...
- Only the `ST-12` clause now carries one defended historical date: `2026-02-03`, taken from the accepted labs evidence-time audit for `S0A-2A-R03-SUP-01`. The broader `0002` release frontmatter and `ST-13` remain chronology-incomplete because current upstream evidence still does not defend one unified earlier-labs start for the entire mixed release.
