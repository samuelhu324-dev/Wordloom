...
- This view is the current family-first front door for the `DOC` contract family.
...
- The current `DOC` front door is family-first rather than registry-first:
  ...
  - then open the active family-owned contract body for the relevant `DOC` area in the first mapped quartet
  - use retained source-owner logs primarily for lineage, evidence, and concentrated historical traceability for those active rule sets
...
- `GOVERNANCE-CONTRACT-TAXONOMY-AND-PLACEMENT-MODEL`:
  - active current contract: `docs/governance/contract/DOC-TAX-0001-governance-contract-taxonomy-and-placement-model.md`
