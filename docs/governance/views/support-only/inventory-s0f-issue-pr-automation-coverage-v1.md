...
| `2` | `2` | `0` | `0` | `0` | `2` | `historical-reviewable` | smallest fully uncovered historical packet; likely first non-`1*` candidate |
...
| `6` | `3` | `0` | `0` | `0` | `3` | `historical-reviewable` | small observability/history packet; candidate for early review |
...
| `2` | `missing-series` | `S0F-2A, S0F-2B` | `2` | `missing` | `missing` | `historical-reviewable` | smallest fully uncovered historical series; natural first rollout candidate |
...
| `6` | `missing-series` | `S0F-6A, S0F-6B, S0F-6C` | `3` | `missing` | `missing` | `historical-reviewable` | compact packet; likely early review candidate after `S0F-2*` |
