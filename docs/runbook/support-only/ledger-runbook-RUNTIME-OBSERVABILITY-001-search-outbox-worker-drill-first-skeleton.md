...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `RBL-02-SC-01` | `RBL-02` | `es_429_inject` | `current-family` | `release-ledger-only` | `release-ledger` | `awaiting-writeback` | `pending-p3` | `pending` | `RBL-02-SC-E01` | `RBL-02-SUP-01; RBL-02-SUP-02; RBL-02-SUP-03` | `Current-family scenario not yet written into the runbook body.` |
...
| `RBL-02-SC-03` | `RBL-02` | `es_down_connect` | `current-family` | `release-ledger-only` | `release-ledger` | `awaiting-writeback` | `pending-p3` | `pending` | `RBL-02-SC-E03` | `RBL-02-SUP-01; RBL-02-SUP-02; RBL-02-SUP-03` | `Current-family scenario not yet written into the runbook body.` |
| `RBL-02-SC-04` | `RBL-02` | `es_timeout` | `current-family` | `release-ledger-only` | `release-ledger` | `awaiting-writeback` | `pending-p3` | `pending` | `RBL-02-SC-E04` | `RBL-02-SUP-01; RBL-02-SUP-02; RBL-02-SUP-03` | `Current-family scenario not yet written into the runbook body.` |
| `RBL-02-SC-05` | `RBL-02` | `es_bulk_partial` | `current-family` | `release-ledger-only` | `release-ledger` | `awaiting-writeback` | `pending-p3` | `pending` | `RBL-02-SC-E05` | `RBL-02-SUP-01; RBL-02-SUP-02; RBL-02-SUP-03` | `Current-family scenario not yet written into the runbook body.` |
| `RBL-02-SC-06` | `RBL-02` | `db_claim_contention` | `current-family` | `release-ledger-only` | `release-ledger` | `awaiting-writeback` | `pending-p3` | `pending` | `RBL-02-SC-E06` | `RBL-02-SUP-01; RBL-02-SUP-02; RBL-02-SUP-03` | `Current-family scenario not yet written into the runbook body.` |
| `RBL-02-SC-07` | `RBL-02` | `stuck_reclaim` | `current-family` | `release-ledger-only` | `release-ledger` | `awaiting-writeback` | `pending-p3` | `pending` | `RBL-02-SC-E07` | `RBL-02-SUP-01; RBL-02-SUP-02; RBL-02-SUP-03` | `Current-family scenario not yet written into the runbook body.` |
| `RBL-02-SC-08` | `RBL-02` | `duplicate_delivery` | `current-family` | `release-ledger-only` | `release-ledger` | `awaiting-writeback` | `pending-p3` | `pending` | `RBL-02-SC-E08` | `RBL-02-SUP-01; RBL-02-SUP-02; RBL-02-SUP-03` | `Current-family scenario not yet written into the runbook body.` |
| `RBL-02-SC-09` | `RBL-02` | `projection_version` | `current-family` | `release-ledger-only` | `release-ledger` | `awaiting-writeback` | `pending-p3` | `pending` | `RBL-02-SC-E09` | `RBL-02-SUP-01; RBL-02-SUP-02; RBL-02-SUP-03` | `Current-family scenario not yet written into the runbook body.` |
...
| `RBL-02-SC-12` | `RBL-02` | `shadow_verify_search_index_write_gate` | `sibling-family` | `not-owned-here` | `pending-sibling-lane` | `routed-out-pending` | `sibling-ledger` | `pending-p3` | `RBL-02-SC-E12` | `RBL-02-SUP-01; RBL-02-SUP-03` | `This scenario is explicitly outside current runbook ownership and awaits sibling routing.` |
| `RBL-02-SC-13` | `RBL-02` | `shadow_verify_search_index_paging_stability` | `sibling-family` | `not-owned-here` | `pending-sibling-lane` | `routed-out-pending` | `sibling-ledger` | `pending-p3` | `RBL-02-SC-E13` | `RBL-02-SUP-01; RBL-02-SUP-03` | `This scenario is explicitly outside current runbook ownership and awaits sibling routing.` |
| `RBL-02-SC-14` | `RBL-02` | `rehearsal_search_read_switch_smoke` | `sibling-family` | `not-owned-here` | `pending-sibling-lane` | `routed-out-pending` | `sibling-ledger` | `pending-p3` | `RBL-02-SC-E14` | `RBL-02-SUP-01; RBL-02-SUP-03` | `This scenario is explicitly outside current runbook ownership and awaits sibling routing.` |
| `RBL-02-SC-15` | `RBL-02` | `shadow_verify_dual_run_readiness_gate` | `sibling-family` | `not-owned-here` | `pending-sibling-lane` | `routed-out-pending` | `sibling-ledger` | `pending-p3` | `RBL-02-SC-E15` | `RBL-02-SUP-01; RBL-02-SUP-03` | `This scenario is explicitly outside current runbook ownership and awaits sibling routing.` |
| `RBL-02-SC-16` | `RBL-02` | `shadow_verify_dual_run_stage1` | `sibling-family` | `not-owned-here` | `pending-sibling-lane` | `routed-out-pending` | `sibling-ledger` | `pending-p3` | `RBL-02-SC-E16` | `RBL-02-SUP-01; RBL-02-SUP-03` | `This scenario is explicitly outside current runbook ownership and awaits sibling routing.` |
| `RBL-02-SC-17` | `RBL-02` | `shadow_verify_dual_run_stage2` | `sibling-family` | `not-owned-here` | `pending-sibling-lane` | `routed-out-pending` | `sibling-ledger` | `pending-p3` | `RBL-02-SC-E17` | `RBL-02-SUP-01; RBL-02-SUP-03` | `This scenario is explicitly outside current runbook ownership and awaits sibling routing.` |
| `RBL-02-SC-18` | `RBL-02` | `shadow_verify_dual_run_window` | `sibling-family` | `not-owned-here` | `pending-sibling-lane` | `routed-out-pending` | `sibling-ledger` | `pending-p3` | `RBL-02-SC-E18` | `RBL-02-SUP-01; RBL-02-SUP-03` | `This scenario is explicitly outside current runbook ownership and awaits sibling routing.` |
| `RBL-02-SC-19` | `RBL-02` | `shadow_verify_canary_dual_write` | `sibling-family` | `not-owned-here` | `pending-sibling-lane` | `routed-out-pending` | `sibling-ledger` | `pending-p3` | `RBL-02-SC-E19` | `RBL-02-SUP-01; RBL-02-SUP-03` | `This scenario is explicitly outside current runbook ownership and awaits sibling routing.` |
| `RBL-02-SC-20` | `RBL-02` | `shadow_verify_dual_write_sampling` | `sibling-family` | `not-owned-here` | `pending-sibling-lane` | `routed-out-pending` | `sibling-ledger` | `pending-p3` | `RBL-02-SC-E20` | `RBL-02-SUP-01; RBL-02-SUP-03` | `This scenario is explicitly outside current runbook ownership and awaits sibling routing.` |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `RBL-02-SC-01` | `unknown` | `2026-04-27` | `2026-04-27` | `pending` | `day` | `none` | `Scenario first became explicitly classifiable in S4G-1G and is still awaiting downstream write-back.` |
...
| `RBL-02-SC-03` | `unknown` | `2026-04-27` | `2026-04-27` | `pending` | `day` | `none` | `Scenario first became explicitly classifiable in S4G-1G and is still awaiting downstream write-back.` |
| `RBL-02-SC-04` | `unknown` | `2026-04-27` | `2026-04-27` | `pending` | `day` | `none` | `Scenario first became explicitly classifiable in S4G-1G and is still awaiting downstream write-back.` |
| `RBL-02-SC-05` | `unknown` | `2026-04-27` | `2026-04-27` | `pending` | `day` | `none` | `Scenario first became explicitly classifiable in S4G-1G and is still awaiting downstream write-back.` |
| `RBL-02-SC-06` | `unknown` | `2026-04-27` | `2026-04-27` | `pending` | `day` | `none` | `Scenario first became explicitly classifiable in S4G-1G and is still awaiting downstream write-back.` |
| `RBL-02-SC-07` | `unknown` | `2026-04-27` | `2026-04-27` | `pending` | `day` | `none` | `Scenario first became explicitly classifiable in S4G-1G and is still awaiting downstream write-back.` |
| `RBL-02-SC-08` | `unknown` | `2026-04-27` | `2026-04-27` | `pending` | `day` | `none` | `Scenario first became explicitly classifiable in S4G-1G and is still awaiting downstream write-back.` |
| `RBL-02-SC-09` | `unknown` | `2026-04-27` | `2026-04-27` | `pending` | `day` | `none` | `Scenario first became explicitly classifiable in S4G-1G and is still awaiting downstream write-back.` |
...
- Scenario-level routing is now explicit under `RBL-02`, so later `P3` write-back can show exactly which scenario stayed here, landed in the runbook, or moved to a sibling lane.