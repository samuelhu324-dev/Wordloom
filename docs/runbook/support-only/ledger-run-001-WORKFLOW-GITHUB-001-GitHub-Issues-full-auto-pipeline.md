...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `RUN-001-E01` | `RUN-001` | `—` | `—` | `docs/runbook/run-WORKFLOW-GITHUB-001-GitHub-Issues-full-auto-pipeline.md` | `md` | `full` | `runbook family, workflow profiles, ledger binding, minimum admitted fields` | `verified` | `runbook identity rewrite` | The bound runbook release remains the root contract evidence for the first admitted live child batch under the narrowed GitHub Issues family identity. |
