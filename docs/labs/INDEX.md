...
| `lab-S2B-2A-2A-dual-run-cutover-closure` | v2：分页稳定性 + 共享键 + dual-run/cutover 收口 | 2026-02-19 (CI ok: paging `22164058062-1`, shared-keys `22164060556-1`, canary `22168857459-1`; sampling CI pending, local ok: `20260219T133300-sampling-run1`, `20260219T133500-sampling-dlq-replay-run1`) | `.github/workflows/drill-write-gate.yml` | draft |
