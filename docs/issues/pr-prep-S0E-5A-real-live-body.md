...
- - `22b00afc` / `S0E-5A` / `P0-P2`: add lifecycle audit gate and dry-run planner
- - `593919fc` / `S0E-5A` / `P3`: add lifecycle remediation planning layer
- - `2bcc12fa` / `S0E-5A` / `P4`: add unified lifecycle pre-gate orchestration
- - `47cd1812` / `S0E-5A` / `P5`: guard issue conclusion apply with pre-gate
- - `77ff9eba` / `S0E-5A` / `P5-C2-S1`: create live issue and write back log link
