...
- Thin gate result artifact: `docs/issues/publish-verify-remediation-gate-S0E-7F-p2-stop-pr-create-preflight-thin-gate-result.json`
- Wrapper result artifact: `docs/issues/publish-verify-remediation-gate-S0E-7F-p2-stop-pr-create-preflight-wrapper-result.json`
