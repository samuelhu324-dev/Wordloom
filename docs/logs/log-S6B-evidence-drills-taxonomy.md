...
- 2026-04-04: `S6B-1C/P3` fixed the first legacy-alias retirement gate for tracked retained-summary coexistence, including dual-write stop conditions, active-alias retirement conditions, and a bounded observation/rollback rule before alias removal.
