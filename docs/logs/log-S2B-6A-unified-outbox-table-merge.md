...
- [x] `P2-C4-S4`：Slice D-4：Ops/replay 脚本清理（Chronicle 侧统一 outbox；按 ledger L10）。
...
### P2-C4-S4（Slice D-4：Ops/replay 脚本清理（Chronicle replay 统一入口）；post write-gate 6-pack：本地 N=3 rounds）

- headSha: `c303b7cb7d5e2ed130fa609f4a17a72322020aa2`（`S2B-6A/P2-C4-S4: make chronicle replay stable; drop legacy`）
...
- post suite root（round1–round3；每轮 6-pack）：
  - `artifacts/_local_s2b6a/P2-C4-S4/20260228-164847/post/round1/`
  - `artifacts/_local_s2b6a/P2-C4-S4/20260228-164847/post/round2/`
  - `artifacts/_local_s2b6a/P2-C4-S4/20260228-164847/post/round3/`
