...
- `S0F-7B/P4-C1-S1S2S3` is now complete in workspace: the canonical contract template now carries family/release metadata, cumulative source carry-forward, and one recommended body shape that keeps both release delta and current-state meaning readable.
