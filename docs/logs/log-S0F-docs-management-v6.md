...
- `S0F-7B/P3-C1-S1S2S3+P3-C2-S1S2S3` is now complete in workspace: the support-only ledger model now uses source-owned naming, explicit consumption tracking, and one regenerated `S0B-2A` sample ledger that can later show what was consumed versus what remained unconsumed.
