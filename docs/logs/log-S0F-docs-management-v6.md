...
- `S0F-7E/P6-C1-S1S2` is now complete in workspace: the repo now prefers canonical UTC-second timestamps for new artifact-lifecycle and recorded chronology fields, and the support-only ledger plus SUP models now expose explicit time-audit surfaces for parent rows and evidence items.
