...
- `S0F-7F/P4-C1-S1S2` is now complete: the repo now applies the fixed timing model to one live ledger/SUP sample by adding lifecycle fields to `ledger-S0A-1A`, renaming the first Projects supplement as `SUP-001`, and recording the three screenshot evidence items as one explicit day-precision `2026-02-12` time audit.
