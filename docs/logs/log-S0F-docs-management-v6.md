...
- `S0F-1E/P4` is now complete: the bucketed audit-output contract and representative retained sample are fixed, and no further phase is currently required inside this slice.
