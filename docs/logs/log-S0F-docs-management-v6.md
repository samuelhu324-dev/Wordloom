...
- `S0F-1E/P1` is now complete: creation-stage bucket families and representative check-to-bucket mapping are fixed, and the next follow-up is `P2` PR-stage bucket families.
