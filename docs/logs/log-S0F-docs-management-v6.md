...
- `S0F-1E/P2` is now complete: PR-stage bucket families and representative check-to-bucket mapping are fixed, and the next follow-up is `P3` conclusion-stage bucket families.
