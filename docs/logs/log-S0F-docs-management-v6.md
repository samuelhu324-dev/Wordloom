...
- `S0F-1E/P3` is now complete: conclusion-stage bucket families and representative check-to-bucket mapping are fixed, and the next follow-up is `P4` audit-output contract and retained sample.
