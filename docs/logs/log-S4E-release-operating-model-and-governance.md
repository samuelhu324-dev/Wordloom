...
- `S4E-4A` 已作为下一阶段 draft slice 开出，用于承接 hard-gate vs soft-policy boundary、auditability contract 与 environment-specific approver policy；当前尚未进入实质 contract/evidence 阶段；
