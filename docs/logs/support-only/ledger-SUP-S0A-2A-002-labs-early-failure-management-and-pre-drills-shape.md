...
- The current parent-ledger judgment still keeps the labs layer as bounded background because the broad issue-level source was not treated as strong enough direct owner evidence by itself.
...
- This `002` SUP round intentionally stops at defended evidence admission and parent-ledger rewrite recommendation; it does not yet write into `DOC-WORKFLOW-LABS`.