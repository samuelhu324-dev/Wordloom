...
- `S0F-1K/P4-C2-S1` is now complete as the post-move verification cycle: the six retained lifecycle readers were rechecked after the executed relocation, and no reader regression required direct retargeting away from the root stub.
